...
public class StringManipulation03 {
    public static void main(String[] args) {
        ...
        It provides address / reference of the Non-Primitive data type like a String, map /navigation.
        ...
        STRING POOL:
         ...
         However, if a 'new' keyword is used, a new String object is created in the heap and its
         own reference is created and stored in Stack.

         If the variable from the String pool is modified/updated, it is pushed out of the String pool,
         assigned a new reference in Stack.
